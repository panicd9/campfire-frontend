...
export type Crowdfunding = {
  "address": "Ab1nTbMuFjcfoRJWWAdxPAVotYz2kzPxS18Yzie2iiQt",
  "metadata": {
    "name": "crowdfunding",
    "version": "0.1.0",
    "spec": "0.1.0",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "global_config.next_pool_id",
        ...
        },
        {
          "name": "poolAuthority",
          "docs": [
            "PDA authority that owns the vaults and can mint/transfer RWA"
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "depositMint",
          "docs": [
            "The mint for deposits (e.g., USDC). Not created here; must exist."
          ]
        },
        {
          "name": "systemProgram",
